...
public class CSC300Program3a {
	...
	public static int numUnique (int[] list) {
		int sum = 1;
		/*
		 * preCond: input is either an empty array or an array of ints sorted low to high
		 */
		
		/*
		 * assertion 1: input is empty 
		 */
		if(list.length == 0) {
			return --sum;
		}
		/*
		 * assertion 2: input is 1 value
		 */
		if(list.length == 1) {
			return sum;
		}
		/*
		 * assertion 3: input is  value
		 */
